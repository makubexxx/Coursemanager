...
INSERT INTO `coursenotice` VALUES (1,1,'??????????????','?????????????????????????????????????5???????5?? ','???',5,'2016-03-01 14:13:47'),(2,1,'??????????????','?????????????????????????????????????5???????5?? ','???',5,'2016-03-01 14:16:46'),(3,1,'??????????????','?????????????????????????????????????5???????5?? ','???',5,'2016-03-01 14:17:07'),(4,1,'欢迎各位同学访问我的课程信息','为了鼓励大家积极参与网络课堂，特别提示大家，访问次数和参与讨论次数最多的前5名期末总成绩加5分。 ','张老师',5,'2016-03-01 14:18:26');

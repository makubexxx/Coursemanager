      ...
      <div class="am-u-sm-12">
        <form class="am-form">
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
   <th class="table-id">序号</th><th class="table-title">标题</th><th class="table-type">简要说明</th><th class="table-author am-hide-sm-only">文件大小</th><th class="table-date am-hide-sm-only">上传时间</th>
              </tr>
          </thead>
          <tbody>
...
<c:forEach items="${coursedocumentlist}" var="coursedocument" varStatus="status"  >
        ...
        <tr>
              ...
              <td class="am-hide-sm-only">${coursedocument.documentsize}M</td>
              <td class="am-hide-sm-only">${SimpleDateFormatlist}</td>
              <td>
              </td>
            </tr>
     </c:forEach>

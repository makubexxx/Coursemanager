    ...
    <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list">
      <li class="am-dropdown" data-am-dropdown>
        <a class="am-dropdown-toggle" data-am-dropdown-toggle href="javascript:;">
          <span class="am-icon-users"></span> 用户：${user.userid} 老师 <span class="am-icon-caret-down"></span>
        </a>
...
<div class="am-cf admin-main">
  ...
  <div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
    <div class="am-offcanvas-bar admin-offcanvas-bar">
      <ul class="am-list admin-sidebar-list">
        <li><a  href="/CourseManager/allcourse" target="content_frame" ><span class="am-icon-home"></span> 课程管理</a></li>
  ...
  <div class="admin-content">
      <!--iFrame自适应宽度和高度！ -->
      <iframe id="content_frame" name="content_frame" width=100% onload="this.height=content_frame.document.body.scrollHeight;this.width=content_frame.document.body.scrollWidth" marginwidth=0 marginheight=0 scrolling="no" src="/CourseManager/teachcourselist"frameborder=0 ></iframe>
